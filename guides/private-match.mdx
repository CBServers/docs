...
Due to the nature of these community clients being separated from Steam's infrastructure, you can't add friends through Steam and join their games directly. The connection method depends on which game you're playing. Most games use Radmin VPN or port forwarding, while Plutonium clients have a built-in friends system.

## Prerequisites

- One of the supported game clients installed:
  - [T4 (World at War)](/games/t4)
  - [IW4x (Modern Warfare 2)](/games/iw4x)
  - [T5 (Black Ops)](/games/t5)
  - [IW5 (Modern Warfare 3)](/games/iw5)
  - [T6 (Black Ops 2)](/games/t6)
...
Some clients handle private matches through their own friends system rather than direct IP connections.

| Game | How to Connect |
|------|---------------|
| World at War MP/ZM (T4) | Use the in-game friends list. Manage friends through the [Plutonium Forums](https://forum.plutonium.pw/). |
| Modern Warfare 3 MP (IW5-Mod) | Use the in-game friends list. Manage friends through the [Plutonium Forums](https://forum.plutonium.pw/). |
| Black Ops MP/ZM (T5) | Use the in-game friends list. Manage friends through the [Plutonium Forums](https://forum.plutonium.pw/). |
| Black Ops 2 MP/ZM (T6) | Use the in-game friends list. Manage friends through the [Plutonium Forums](https://forum.plutonium.pw/). |
...
The following games require Radmin VPN or port forwarding to play private matches with friends.
